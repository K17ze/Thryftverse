...
export default function BalanceScreen({ navigation }: Props) {
  ...
  // Real layout restoration of Pending/Available balances
  const [availableBalance, setAvailableBalance] = useState(120.50);
  const [pendingBalance, setPendingBalance] = useState(45.00);
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.hugeTitle}>Balance</Text>
      </View>
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.heroGroup}>
          <View style={styles.pendingCard}>
            ...
            <View style={{flexDirection: 'row', alignItems: 'center', gap: 8}}>
              <Text style={styles.pendingAmount}>£{pendingBalance.toFixed(2)}</Text>
          ...
          <View style={styles.balanceHero}>
            ...
            <View style={styles.balanceActions}>
              <TouchableOpacity style={styles.actionBtn} activeOpacity={0.8} onPress={() => navigation.navigate('Withdraw')}>
              ...
              <TouchableOpacity style={styles.actionBtn} activeOpacity={0.8}>
                <View style={styles.actionCircle}><Ionicons name="heart-outline" size={24} color={Colors.textPrimary} /></View>
        ...
        <View style={styles.historyCard}>
          <View style={styles.historyRow}>
            ...
            <Text style={styles.historyTitle}>£0.00</Text>
          </View>
          <TouchableOpacity style={styles.historyLinkRow} onPress={() => navigation.navigate('BalanceHistory')}>
