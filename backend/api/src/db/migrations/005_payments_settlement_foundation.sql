...
CREATE TABLE IF NOT EXISTS payment_intents (
  ...
  user_id TEXT NOT NULL REFERENCES users(id) ON DELETE CASCADE,
  gateway_id TEXT NOT NULL REFERENCES payment_gateways(id) ON DELETE RESTRICT,
  channel TEXT NOT NULL CHECK (channel IN ('commerce', 'co-own', 'wallet_topup', 'wallet_withdrawal')),
  order_id TEXT REFERENCES orders(id) ON DELETE SET NULL,
  coOwn_order_id BIGINT REFERENCES coOwn_orders(id) ON DELETE SET NULL,
